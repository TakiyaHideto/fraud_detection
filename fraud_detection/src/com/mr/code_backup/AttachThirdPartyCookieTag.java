...
/**
 * Created by TakiyaHideto on 15/12/4.
 */
public class AttachThirdPartyCookieTag {
...
//                return;
            ...
            String yoyiCookie = line.replaceAll("=","-");
            String tagAttachment = context.getConfiguration().get("tag");
    ...
    public static class AttachThirdPartyCookieTagReducer extends Reducer<Text, Text, NullWritable, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values,Context context)
            ...
            value_result.set(key.toString() + Properties.Base.BS_SEPARATOR + context.getConfiguration().get("tag"));
    ...
    public static void main(String[] args) throws Exception{
        ...
        Job job = new Job(conf,"AttachThirdPartyCookieTag");
...
//        job.getConfiguration().set("mapred.output.compression.codec", "org.apache.hadoop.io.compress.GzipCodec");
        ...
        job.setJarByClass(AttachThirdPartyCookieTag.class);
        ...
        job.getConfiguration().set("tag",otherArgs[2]);
