...
class_name=com.mr.temp.CheckSpecificOrderFraudDomain

output_path=/mroutput/dongjiahao/CheckSpecificOrderFraudDomain/log_date=$ONE_DAY_AGO
...
hadoop fs -text /mroutput/dongjiahao/CheckSpecificOrderFraudDomain/log_date=$ONE_DAY_AGO/part* > CheckSpecificOrderFraudDomain_ori
python /data/dongjiahao/svn_project/fraudDetection/trunk/src/com/mr/data_analysis_python/temp_function/calDomainCtr.py
