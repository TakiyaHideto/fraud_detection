 ...
 */
public class CollectYoyiCpDataAndPredict {
    public static class CollectYoyiCpDataAndPredictMapper extends Mapper<Object, Text, Text, Text> {
...
//                            value_result.set(appType + ":1" + Properties.Base.CTRL_A + "appType");
    ...
    public static class CollectYoyiCpDataAndPredictReducer extends Reducer<Text, Text, NullWritable, Text> {
        private Text key_result = new Text();
        private Text value_result = new Text();
...
//                hasCookieData = false;
    ...
    public static void main(String[] args) throws Exception{
        ...
        Job job = new Job(conf,"CollectYoyiCpDataAndPredict");
        ...
        job.setJarByClass(CollectYoyiCpDataAndPredict.class);
        job.setReducerClass(CollectYoyiCpDataAndPredictReducer.class);
...
//        String bidMidlogAccuPath = otherArgs[2];
        ...
        CommUtil.addInputFileComm(job, fs, bidMidLogPath, TextInputFormat.class, CollectYoyiCpDataAndPredictMapper.class);
