...
/**
 * Created by TakiyaHideto on 15/12/25.
 */
public class CookieVolumeViaDomainIp {
    public static class CookieVolumeViaDomainIpMapper extends Mapper<Object, Text, Text, Text> {
    ...
    public static class CookieVolumeViaDomainIpReducer extends Reducer<Text, Text, NullWritable, Text> {
        private Text key_result = new Text();
        private Text value_result = new Text();
    ...
    public static void main(String[] args) throws Exception{
        ...
        Job job = new Job(conf,"CookieVolumeViaDomainIp");
        ...
        job.setJarByClass(CookieVolumeViaDomainIp.class);
        job.setReducerClass(CookieVolumeViaDomainIpReducer.class);
        ...
        CommUtil.addInputFileCommSucc(job, fs, bidLogDataPath, TextInputFormat.class, CookieVolumeViaDomainIpMapper.class, "all");
