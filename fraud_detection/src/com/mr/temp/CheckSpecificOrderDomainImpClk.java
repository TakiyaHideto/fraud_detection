 ...
 */
public class CheckSpecificOrderDomainImpClk {
    ...
    public static class CheckSpecificOrderDomainImpClkReducer extends Reducer<Text, Text, NullWritable, Text> {
        private Text key_result = new Text();
        private Text value_result = new Text();
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context)
            ...
            for (Text value : values) {
                ...
                if (value.toString().contains("impLog")) {
                    imp ++;
                }
    ...
    public static void main(String[] args) throws Exception{
        ...
        Job job = new Job(conf,"CheckSpecificOrderDomainImpClk");
        ...
        job.setJarByClass(CheckSpecificOrderDomainImpClk.class);
        job.setReducerClass(CheckSpecificOrderDomainImpClkReducer.class);
        ...
        CommUtil.addInputFileCommSucc(job, fs, bidLog, TextInputFormat.class, BidMapper.class,"03");
        CommUtil.addInputFileCommSucc(job, fs, bidLog, TextInputFormat.class, BidMapper.class,"04");
        CommUtil.addInputFileCommSucc(job, fs, bidLog, TextInputFormat.class, BidMapper.class,"05");
