...
ONE_DAY_AGO=`date +%Y-%m-%d --date="-5 day"`
#HOUR=`date -d -1hour +%H`

jar_dir=/data/dongjiahao/svn_project/fraudDetection/trunk/target
jar_name=hadoop_test-1.0-jar-with-dependencies.jar

class_name=com.mr.temp.CheckSpecificOrderFraudWithBid

output_path=/mroutput/dongjiahao/CheckSpecificOrderFraudWithBid/log_date=$ONE_DAY_AGO
